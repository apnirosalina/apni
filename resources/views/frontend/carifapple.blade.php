                ...
                @foreach ($fapple as $fa)
                    <div class="col-md-4">
                        <div class="card"> <img class="gambar" src="image/{{$fa->image}}" class="card-img-top">
                            <div class="card-body">
                                <div class="d-flex justify-content-between"> <span class="font-weight-bold">{{$fa->type}}</span> <span class="font-weight-bold">{{$fa->harga}}</span> </div>
                                <p class="card-text mb-1 mt-1">{{$fa->spesifikasi}}</p>
                                <div class="d-flex align-items-center flex-row"> <img src="{{asset('images/icon.png')}}" width="20"> <span class="guarantee">{{$fa->toko}}</span> </div>
                            </div>
                            <hr>
                            <div class="card-body">
