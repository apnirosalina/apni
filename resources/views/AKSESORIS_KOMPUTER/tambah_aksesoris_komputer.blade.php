...
@section('judul','Tambah Produk Aksesoris komputer')

@section('isi')
<h1 class="mt-3">Tambah Produk Aksesoris komputer</h1>

    <form method="post" action='/prosestambahaksesoriskomputer' enctype="multipart/form-data">
            @csrf
