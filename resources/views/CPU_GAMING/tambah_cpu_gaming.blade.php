...
@section('judul','Tambah Produk Cpu gaming')

@section('isi')
<h1 class="mt-3">Tambah Produk Cpu gaming</h1>

    <form method="post" action='/prosestambahcpugaming' enctype="multipart/form-data">
            @csrf
